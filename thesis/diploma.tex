...
\begin{figure}[h]
    \begin{center}        
        \begin{tikzpicture}[shorten >=1pt,-]
            \tikzstyle{vertex}=[circle,draw=black,fill=white!25,minimum size=20pt,inner sep=0pt]
                \node[vertex] (V-1) at (0, 3){};
        
                \node[vertex] (V-2) at (2, 2){};
                \node[vertex] (V-3) at (2, 4){};
                
                \node[vertex] (V-4) at (5, 2){};
                \node[vertex] (V-5) at (4, 4){};
                \node[vertex] (V-6) at (6, 4){};
                
                \node[vertex] (V-7) at (8, 0){};
                \node[vertex] (V-8) at (10, 0){};
                \node[vertex] (V-9) at (9, 2){};
                \node[vertex] (V-10) at (9, 4){};
                \node[vertex] (V-11) at (8, 6){};
                \node[vertex] (V-12) at (10, 6){};
                    
                \foreach \from/\to in {2/3, 4/5, 4/6, 7/9, 8/9, 9/10, 10/11, 10/12}
                    \draw (V-\from) -- (V-\to);
        
                    
                \filldraw [black] (4.8,4) circle (1pt);
                \filldraw [black] (5,4) circle (1pt);
                \filldraw [black] (5.2,4) circle (1pt);
        
                \filldraw [black] (8.8,0) circle (1pt);
                \filldraw [black] (9,0) circle (1pt);
                \filldraw [black] (9.2,0) circle (1pt);
                \filldraw [black] (8.8,6) circle (1pt);
                \filldraw [black] (9,6) circle (1pt);
                \filldraw [black] (9.2,6) circle (1pt);
        \end{tikzpicture}
    \end{center}
