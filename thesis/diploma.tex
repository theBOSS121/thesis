...
\newcommand{\tkeywords}{permutacije, inverzije permutacij, Bruhatovi delni urejenosti permutacij, rodovne funkcije permutacij, Lehmerjeva koda, vektor inverzij, faktorski številski sistem, rangiranja, permutacijski grafi, tekmovalnostni grafi, primerljivostni grafi, kohezivno zaporedje grafa, gosenica, množica posrednih in neposrednih tekmovalcev}
\newcommand{\tkeywordsEn}{permutations,  inversions of permutations, Bruhat partial orders, generating function of permutations, Lehmer code, Inversion vector, factorial number system, rankings, permutation graphs, competitivity graphs, comparability graphs, cohesive order of a graph, caterpillar, set of eventual competitors}
...
\end{trditev}
\begin{dokaz}
    Permutacija $\pi = (n+1, 1, 2, \dots, n)$ je kohezivno zaporedje zvezde $K_{1, n}$ (slika \ref{graf_kohezivnega_zaporedja_zvezda}), saj sta izpolnjena pogoja $(a)$ in $(b)$ iz definicije kohezivnega zaporedja \ref{def_kohezivno_zaporedje}.
\end{dokaz}
