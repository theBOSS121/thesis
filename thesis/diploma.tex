...
Relacija $R$ na neprazni množici $A$ je množica urejenih parov elementov iz $A$, to pomeni $R\subseteq A\times A, A\neq\emptyset$. $(x, y) \in R$ pomeni $x$ je v relaciji $R$ z $y$, kar označimo z $xRy$. Relacija $R$ je lahko:
\begin{itemize}
    \item refleksivna $\Leftrightarrow \forall x\in A: xRx$,
    \item irefleksivna $\Leftrightarrow \forall x\in A: \neg xRx$,
    \item simetrična $\Leftrightarrow \forall x,y\in A: xRy \Rightarrow yRx$,
    \item asimetrična $\Leftrightarrow \forall x,y\in A: xRy \Rightarrow \neg yRx$,
    \item antisimetrična $\Leftrightarrow \forall x,y\in A: xRy \Rightarrow x = y \lor \neg yRx$,
    \item tranzitivna $\Leftrightarrow \forall x,y,z\in A: xRy \land yRz \Rightarrow xRz$,
    \item sovisna $\Leftrightarrow \forall x,y\in A: x \neq y \Rightarrow xRy \lor yRx $ (x in y sta primerljiva),
    \item  strogosovisna $\Leftrightarrow \forall x,y\in A: xRy \lor yRx $.
\end{itemize}
...
\begin{itemize}
    ...
    \item stroga delna urejenost, če je $R$ je asimetrična in tranzitivna (irefleksivna),
    \item stroga linearna urejenost, če je $R$ je asimetrična, sovisna in transitivna.
\end{itemize}
Če je $R$ linearna urejenost, potem je tudi delna urejenost. Če je $R$ stroga linearna urejenost, potem je tudi stroga delna urejenost.
